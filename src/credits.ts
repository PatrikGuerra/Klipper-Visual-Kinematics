...
export const credits: CreditItem[] = [
  ...
  { name: 'Class Variance Authority', repoUrl: 'https://github.com/joe-bell/cva', usageRank: 41 },
  { name: 'clsx', repoUrl: 'https://github.com/lukeed/clsx', usageRank: 42 },
  { name: 'tailwind-merge', repoUrl: 'https://github.com/dcastil/tailwind-merge', usageRank: 43 },
  { name: 'Tailwind CSS', repoUrl: 'https://github.com/tailwindlabs/tailwindcss', usageRank: 50 },
  { name: 'tailwindcss-animate', repoUrl: 'https://github.com/jamiebuilds/tailwindcss-animate', usageRank: 51 },
