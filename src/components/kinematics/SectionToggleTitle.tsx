  ...
  return (
    <div class="panel-title panel-title-toggle">
      <label classList={{ disabled: !!props.disabled }} class="section-toggle-title" title={props.tooltip} for={props.id}>
        <input id={props.id} class="checkbox checkbox-primary checkbox-sm" type="checkbox" checked={props.checked} disabled={props.disabled} onChange={(event) => props.onChange(event.currentTarget.checked)} />
